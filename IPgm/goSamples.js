...
if (window.require) {
  ...
  require.config({
    paths: {
      "highlight": "C:/xampp/htdocs/IPgm/GoJS-master/assets/js/highlight.js",
      "jquery": "C:/xampp/htdocs/IPgm/GoJS-master/assets/js/jquery.min", // 1.11.3
      "bootstrap": "C:/xampp/htdocs/IPgm/GoJS-master/assets/js/bootstrap.min"
    },
    shim: {
      "bootstrap": ["jquery"]
    }
  ...
  function goLoadSrc(filenames) {
    ...
    for (var i = 0; i < arguments.length; i++) {
      ...
      selt.async = false;
      selt.defer = false;
      selt.src = "C:/xampp/htdocs/IPgm/GoJS-master/assets/js/" + filename;
...
link.type = "text/css";
link.rel = "stylesheet";
link.href = "C:/xampp/htdocs/IPgm/GoJS-master/assets/css/bootstrap.min.css";
head.appendChild(link);

link = document.createElement("link");
link.type = "text/css";
link.rel = "stylesheet";
link.href = "C:/xampp/htdocs/IPgm/GoJS-master/assets/css/highlight.css";
head.appendChild(link);

link = document.createElement("link");
link.type = "text/css";
link.rel = "stylesheet";
link.href = "C:/xampp/htdocs/IPgm/GoJS-master/assets/css/main.css";
head.appendChild(link);
...
function goSamples() {
  ...
  for (var i = 0; i < l; i++) {
    ...
    img.height = "200";
    img.src = "C:/xampp/htdocs/IPgm/GoJS-master/assets/images/screenshots/" + imgname + ".png";
...
function _traverseDOM(node) {
  if (node.nodeType === 1 && node.nodeName === "A" && !node.getAttribute("href")) {
    ...
    if (text.length === 1) {
      node.setAttribute("href", "C:/xampp/htdocs/IPgm/GoJS-master/api/symbols" + text[0] + ".html");
      node.setAttribute("target", "api");
    } else if (text.length === 2) {
      node.setAttribute("href", "C:/xampp/htdocs/IPgm/GoJS-master/api/symbols" + text[0] + ".html" + "#" + text[1]);
      node.setAttribute("target", "api");
    } else {
    ...
    <div class="navbar navbar-default" role="navigation">/
      ...
      <div id="DiagramNavbar" class="navbar-collapse collapse sidebar-navbar-collapse">/
        <ul id="sections" class="classList nav navbar-nav">/
          ...
          <li><a href="logi cCircuit.html">Logic Circuit</a></li>/
